...
START_TEST(test_convert_name)
{
  char *name = convert_name("FILE.BIN");
...
TCase *create_libfat12_filename_case(void)
{
  ...
  tcase_add_test(tc_libfat12_filename, test_get_file_name);
  tcase_add_test(tc_libfat12_filename, test_convert_name);
